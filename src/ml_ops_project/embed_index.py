...
def build_index(chunks: list[Chunk], model_name: str = "all-MiniLM-L6-v2") -> tuple[faiss.Index, SentenceTransformer]:
    ...
    return index, sentence_model

def save_index(index: faiss.Index, chunks: list[Chunk], out_dir: Path) -> None:
